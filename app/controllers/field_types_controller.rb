class FieldTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @field_type.save
        format.html { redirect_to field_types_path, notice: 'Field type was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @field_type.update_attributes(params[:field_type])
        format.html { redirect_to field_types_path, notice: 'Field type was successfully updated.' }
